...
children:
  ...
  %%__CLASSES__%%
'''
        result = expand_macros(dcfg, class_names=["Pipeline", "SourceNode"])
...
children:
  ...
  %%__CLASSES__.exclude(SourceNode)%%
'''
        result = expand_macros(dcfg, class_names=["Pipeline", "SourceNode", "SinkNode"])
        assert '- title: "Pipeline Class"' in result
...
children:
  ...
  %%__CLASSES__%%
'''
        result = expand_macros(dcfg, class_names=[])
...
children:
  ...
  - title: "Another Manual"
    template: "another"
'''
        result = expand_macros(dcfg, class_names=["Pipeline"])
    ...
    def test_no_macros(self):
        """DCFG without macros should be returned unchanged."""
        dcfg = '''
children:
  - title: "Manual Page"
    template: "manual"
...
children:
  ...
  %%__FUNCTIONS__%%
'''
        result = expand_macros(dcfg, function_names=["run", "stop"])
...
children:
  ...
  %%__FUNCTIONS__.exclude(stop)%%
'''
        result = expand_macros(dcfg, function_names=["run", "stop", "pause"])
...
children:
  ...
  %%__INVALID__%%
'''
        with pytest.raises(DCFGPreprocessorError) as exc_info:
            expand_macros(dcfg, class_names=["Pipeline"])
...
children:
  ...
  %%__CLASSES__.exclude(InternalHelper)%%
'''
        result = expand_macros(dcfg, class_names=["Pipeline", "SourceNode", "InternalHelper"])
...
children:
  ...
  %%__CLASSES__.exclude(InternalHelper, BaseClass)%%
'''
        result = expand_macros(dcfg, class_names=["Pipeline", "InternalHelper", "BaseNode", "BaseClass"])
...
children:
  ...
  %%__CLASSES__%%
'''
        result = expand_macros(dcfg, class_names=["BaseNode", "_InternalClass"])
        assert "BaseNode" in result
